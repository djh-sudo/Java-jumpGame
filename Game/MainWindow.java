...
public class MainWindow {
	...
	private void initialize() {
		...
		JPanel singleWindow = new JPanel();
		singleWindow.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		gl_panelSinglePlay.setHorizontalGroup(
				...
				.addGroup(gl_panelSinglePlay.createSequentialGroup()
						.addContainerGap()
						.addComponent(singleWindow, GroupLayout.PREFERRED_SIZE, 1014, GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(gl_panelSinglePlay.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panelSinglePlay.createSequentialGroup()
										...
										.addGroup(gl_panelSinglePlay.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_panelSinglePlay.createSequentialGroup()
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(singleWindow, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE))
												.addGroup(gl_panelSinglePlay.createSequentialGroup()
														.addGap(30)
